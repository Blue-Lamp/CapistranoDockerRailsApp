...
set :application, 'CapistranoDockerizedRailsApp'
set :repo_url, 'git@github.com:Blue-Lamp/CapistranoDockerizedRailsApp.git'

# Default branch is :master
# ask :branch, `git rev-parse --abbrev-ref HEAD`.chomp

# Default deploy_to directory is /var/www/CapistranoDockerizedRailsApp
# set :deploy_to, "/var/www/CapistranoDockerizedRailsApp"
...
append :linked_dirs, 'containers/production/rails/envirovents'
